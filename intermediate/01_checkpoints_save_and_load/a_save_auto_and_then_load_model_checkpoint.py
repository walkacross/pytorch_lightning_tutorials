...
trainer = Trainer(
    ...
    #!
    default_root_dir=checkpoint_to_save_dir
)
...
# checkpoint_path = "/data/user/yujiang/tmp/pl/sample-mnist-epoch=09-val_loss=-12.99.ckpt"
...
# print(model.my_custom_learningin_rate)
